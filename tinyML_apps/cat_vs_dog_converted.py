...
def format_image(image, label):
    image = tf.image.resize(image, (224, 224)) / 225.0
    return image, label


# Split the dataset 80% for training, 10% for validation and last 10% for testing
...
CATS_VS_DOGS_SAVED_MODEL = 'saved_model/catsvsdogs_saved_model'
